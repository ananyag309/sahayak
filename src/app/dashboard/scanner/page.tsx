...
const languageConfig = {
    ...
    hi: { name: 'Hindi', fontName: 'NotoSansDevanagari', buttonText: 'हिंदी वर्कशीट डाउनलोड करें', fontUrl: 'https://fonts.gstatic.com/s/notosansdevanagari/v15/0cEOJGdmNPrfsU92weK1cz55_3-Q5i8sS324.ttf' },
    mr: { name: 'Marathi', fontName: 'NotoSansDevanagari', buttonText: 'मराठी वर्कशीट डाउनलोड करा', fontUrl: 'https://fonts.gstatic.com/s/notosansdevanagari/v15/0cEOJGdmNPrfsU92weK1cz55_3-Q5i8sS324.ttf' },
    ta: { name: 'Tamil', fontName: 'NotoSansTamil', buttonText: 'தமிழ் பணித்தாள் பதிவிறக்கம்', fontUrl: 'https://fonts.gstatic.com/s/notosanstamil/v18/ZXzwYj-hZ8He2F-Xo-i9v0sQ33R3-2H17w.ttf' },
    bn: { name: 'Bengali', fontName: 'NotoSansBengali', buttonText: 'পিডিএফ ডাউনলোড করুন', fontUrl: 'https://fonts.gstatic.com/s/notosansbengali/v15/Cn-SJs2Abtqb2mD55LwxP105a2BBbPFqcw.ttf' },
    te: { name: 'Telugu', fontName: 'NotoSansTelugu', buttonText: 'PDF డౌన్లోడ్ చేయండి', fontUrl: 'https://fonts.gstatic.com/s/notosanstelugu/v16/0FlxV2wt0A7puv2zI81o4A0DEv0_1Wc.ttf' },
    kn: { name: 'Kannada', fontName: 'NotoSansKannada', buttonText: 'ಪಿಡಿಎಫ್ ಡೌನ್ಲೋಡ್ ಮಾಡಿ', fontUrl: 'https://fonts.gstatic.com/s/notosanskannada/v16/xkBUA-D0t2-2-p13g_C3aTpsgHk1aQ.ttf' },
    gu: { name: 'Gujarati', fontName: 'NotoSansGujarati', buttonText: 'પીડીએફ ડાઉનલોડ કરો', fontUrl: 'https://fonts.gstatic.com/s/notosansgujarati/v16/wlpzgw0-D2-_MNDzNaXwG1d-wAba9A.ttf' },
    pa: { name: 'Punjabi', fontName: 'NotoSansGurmukhi', buttonText: 'ਪੀਡੀਐਫ ਡਾਊਨਲੋਡ ਕਰੋ', fontUrl: 'https://fonts.gstatic.com/s/notosansgurmukhi/v16/wEOgETEkpe6SHv5gV-T2mX_d2AFv9A.ttf' },
